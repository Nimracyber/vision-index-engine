      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="space-y-6">
          <div className="bg-slate-900 border border-slate-800 rounded-xl p-5">
            ...
            <form onSubmit={handleSearchSubmit} className="space-y-4">
              <input
                ...
                placeholder="Search anything (e.g. flower, car)..."
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-xl p-5">
            ...
            <label className="border-2 border-dashed border-slate-800 rounded-xl p-6 text-center cursor-pointer hover:border-indigo-500 transition block">
              ...
              <input 
                ...
                onChange={(e) => {
                  if (e.target.files && e.target.files[0]) {
                    ...
                    alert(`Image selected: ${fileName}. Processing visual embeddings...`);
                  }
                }}
              />
            </label>
